...
import brooklyn.location.paas.AbstractPaasContainerLocation;
import brooklyn.location.paas.CloudInfo;


public class CloudFoundryContainerLocation extends AbstractPaasContainerLocation {
